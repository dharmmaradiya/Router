  ...
  return (
    <div className="container mt-5 border border-1">
      ...
      <div className="card p-4 border-0 bg-body-tertiary">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            <input type="text" name="product" className="form-control" value={formData.product} onChange={handleChange} required />
          </div>
      ...
      <div className="mx-auto mt-4 bg-white w-75 text-center">
        ...
        <input type="text" placeholder="Search product..." className="form-control w-50 mx-auto mb-3" value={search} onChange={(e) => setSearch(e.target.value)}/>

        <select className="form-select w-25 mx-auto mb-3" value={sortOrder} onChange={(e) => setSortOrder(e.target.value)}>
